...
<html>
<head>
    <title>Monkey Business - Edit Client</title>
...
<div class="container">
    ...
    <div class="form-group @if ($errors->has('lastname')) has-danger @endif">
        ...
        @if ($errors->has('lasttname')) <div class="form-control-feedback">{{ $errors->first('lasttname') }}</div> @endif
    ...
    {!! Form::submit('Edit the client', array('class' => 'btn btn-secondary')) !!}
    {!! Form::close()  !!}
</div>
</body>
</html>