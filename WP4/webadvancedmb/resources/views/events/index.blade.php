...
<div class="container">
    ...
    <table class="table table-striped table-bordered">
        ...
        @foreach($events as $key => $value)
            <tr>
                ...
                <td>{{ $value->date }}</td>
                <td>
                    <a class="btn btn-small btn-success" href="{{ URL::to('events/' . $value->id) }}">Details</a>
                    <a class="btn btn-small btn-info" href="{{ URL::to('events/' . $value->id . '/edit') }}">Edit</a>
    ...
    <a class="btn btn-secondary" href="{{ URL::to('events/create') }}">Create</a>
